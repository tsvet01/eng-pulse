...
|-------|-----|-------------|
| Gemini | `gemini-3.1-pro-preview` | Google Gemini |
| OpenAI | `gpt-5.2-2025-12-11` | OpenAI GPT |
| Claude | `claude-opus-4-8` | Anthropic Claude |
...
- Model matching supports full IDs (`claude-opus-4-8`), vendor names (`claude`), and any vendor-prefixed ID (e.g. `claude-opus-4-9`) so new model versions are recognized without a client update
